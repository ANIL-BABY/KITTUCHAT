...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","Style_Name_Dpz")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","ll_Unique_Person_ll")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","FRIEND_KI_MASTI")
BOT_NAME = os.environ.get("BOT_NAME","KITTU")
...
SOURCE = 'https://github.com/ANIL-BABY/KITTUCHAT'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
